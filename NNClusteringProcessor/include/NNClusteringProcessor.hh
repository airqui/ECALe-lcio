#ifndef NNClusteringProcessor_h
#define NNClusteringProcessor_h 1
 ...
 *  @version $Id$
 */
class NNClusteringProcessor : public Processor {
  
 public:
  
  virtual Processor*  newProcessor() { return new NNClusteringProcessor ; }
